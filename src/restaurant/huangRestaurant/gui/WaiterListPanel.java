...
public class WaiterListPanel extends JPanel implements ActionListener {
    ...
    private JButton emptyMarket = new JButton("Empty");
    ...
    public WaiterListPanel(RestaurantPanel rp, String type) {
        ...
        emptyMarket.addActionListener(this);
        add(emptyMarket);
        emptyMarket.setEnabled(true);
    ...
    public void actionPerformed(ActionEvent e) {
        if (e.getSource() == addPersonB) {
        	...
        	addPerson(restPanel.getGui().getWaiterNameField());
        	//restPanel.addPerson(, name);
        	//returns a string to put into addPerson args
        }
        else if (e.getSource() == emptyMarket) {
        	restPanel.getHost().getCook().emptyRandomMarket();
        }
        else {
