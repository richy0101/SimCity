...
public class WaiterListPanel extends JPanel implements ActionListener {
    ...
    /**
     * Constructor for WaiterListPanel.  Sets up all the gui
     *
    ...
    public void actionPerformed(ActionEvent e) {
    	if (e.getSource() == addPersonB) {
           ...
           // addPerson(JOptionPane.showInputDialog("Please enter a name:"));
    		//WaiterAgent waiter = new WaiterAgent(restPanel.waiterTxtField.getText());
    		restPanel.addPerson("Waiter",restPanel.waiterTxtField.getText());
        	addPerson(restPanel.waiterTxtField.getText());
        }
        else {
